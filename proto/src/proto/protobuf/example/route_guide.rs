...
impl ::protobuf::PbPrint for Point {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.latitude, "latitude", buf);
        ::protobuf::PbPrint::fmt(&self.longitude, "longitude", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Point {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.latitude, "latitude", &mut s);
        ::protobuf::PbPrint::fmt(&self.longitude, "longitude", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::Message for Rectangle {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.lo, &mut self.lo_offset)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.hi, &mut self.hi_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl ::protobuf::PbPrint for Rectangle {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.lo, "lo", buf);
        ::protobuf::PbPrint::fmt(&self.hi, "hi", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Rectangle {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.lo, "lo", &mut s);
        ::protobuf::PbPrint::fmt(&self.hi, "hi", &mut s);
        write!(f, "{}", s)
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.location, &mut self.location_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl ::protobuf::PbPrint for Feature {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::protobuf::PbPrint for RouteNote {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl PartialEq for RouteSummary {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.point_count == other.point_count && self.feature_count == other.feature_count && self.distance == other.distance && self.elapsed_time == other.elapsed_time
    }
}
...
impl ::protobuf::PbPrint for RouteSummary {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.point_count, "point_count", buf);
        ::protobuf::PbPrint::fmt(&self.feature_count, "feature_count", buf);
        ::protobuf::PbPrint::fmt(&self.distance, "distance", buf);
        ::protobuf::PbPrint::fmt(&self.elapsed_time, "elapsed_time", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for RouteSummary {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.point_count, "point_count", &mut s);
        ::protobuf::PbPrint::fmt(&self.feature_count, "feature_count", &mut s);
        ::protobuf::PbPrint::fmt(&self.distance, "distance", &mut s);
        ::protobuf::PbPrint::fmt(&self.elapsed_time, "elapsed_time", &mut s);
        write!(f, "{}", s)
    }
}
