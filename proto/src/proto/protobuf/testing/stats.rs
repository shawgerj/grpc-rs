...
impl PartialEq for ServerStats {
    ...
    fn eq(&self, other: &Self) -> bool {
        self.time_elapsed == other.time_elapsed && self.time_user == other.time_user && self.time_system == other.time_system && self.total_cpu_time == other.total_cpu_time && self.idle_cpu_time == other.idle_cpu_time && self.cq_poll_count == other.cq_poll_count
    }
}
...
impl ::protobuf::PbPrint for ServerStats {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.time_elapsed, "time_elapsed", buf);
        ::protobuf::PbPrint::fmt(&self.time_user, "time_user", buf);
        ::protobuf::PbPrint::fmt(&self.time_system, "time_system", buf);
        ::protobuf::PbPrint::fmt(&self.total_cpu_time, "total_cpu_time", buf);
        ::protobuf::PbPrint::fmt(&self.idle_cpu_time, "idle_cpu_time", buf);
        ::protobuf::PbPrint::fmt(&self.cq_poll_count, "cq_poll_count", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ServerStats {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.time_elapsed, "time_elapsed", &mut s);
        ::protobuf::PbPrint::fmt(&self.time_user, "time_user", &mut s);
        ::protobuf::PbPrint::fmt(&self.time_system, "time_system", &mut s);
        ::protobuf::PbPrint::fmt(&self.total_cpu_time, "total_cpu_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.idle_cpu_time, "idle_cpu_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.cq_poll_count, "cq_poll_count", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for HistogramParams {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.resolution == other.resolution && self.max_possible == other.max_possible
    }
}
...
impl ::protobuf::PbPrint for HistogramParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.resolution, "resolution", buf);
        ::protobuf::PbPrint::fmt(&self.max_possible, "max_possible", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for HistogramParams {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.resolution, "resolution", &mut s);
        ::protobuf::PbPrint::fmt(&self.max_possible, "max_possible", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for HistogramData {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.bucket == other.bucket && self.min_seen == other.min_seen && self.max_seen == other.max_seen && self.sum == other.sum && self.sum_of_squares == other.sum_of_squares && self.count == other.count
    }
}
...
impl ::protobuf::PbPrint for HistogramData {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.bucket, "bucket", buf);
        ::protobuf::PbPrint::fmt(&self.min_seen, "min_seen", buf);
        ::protobuf::PbPrint::fmt(&self.max_seen, "max_seen", buf);
        ::protobuf::PbPrint::fmt(&self.sum, "sum", buf);
        ::protobuf::PbPrint::fmt(&self.sum_of_squares, "sum_of_squares", buf);
...
impl ::std::fmt::Debug for HistogramData {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.min_seen, "min_seen", &mut s);
        ::protobuf::PbPrint::fmt(&self.max_seen, "max_seen", &mut s);
        ::protobuf::PbPrint::fmt(&self.sum, "sum", &mut s);
        ::protobuf::PbPrint::fmt(&self.sum_of_squares, "sum_of_squares", &mut s);
...
impl PartialEq for RequestResultCount {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.status_code == other.status_code && self.count == other.count
    }
}
...
impl ::protobuf::PbPrint for RequestResultCount {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.status_code, "status_code", buf);
        ::protobuf::PbPrint::fmt(&self.count, "count", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
...
impl ::std::fmt::Debug for RequestResultCount {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.status_code, "status_code", &mut s);
        ::protobuf::PbPrint::fmt(&self.count, "count", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for ClientStats {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.latencies == other.latencies && self.time_elapsed == other.time_elapsed && self.time_user == other.time_user && self.time_system == other.time_system && self.request_results == other.request_results && self.cq_poll_count == other.cq_poll_count
    }
}
...
impl ::protobuf::PbPrint for ClientStats {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
