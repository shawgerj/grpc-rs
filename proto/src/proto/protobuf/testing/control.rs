...
impl PartialEq for PoissonParams {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.offered_load == other.offered_load
    }
}
...
impl ::protobuf::PbPrint for PoissonParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.offered_load, "offered_load", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for PoissonParams {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.offered_load, "offered_load", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for ClosedLoopParams {
...
impl ::protobuf::PbPrint for ClosedLoopParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
    }
}
...
impl ::protobuf::PbPrint for LoadParams_oneof_load {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        match self {
            LoadParams_oneof_load::ClosedLoop(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            LoadParams_oneof_load::Poisson(v) => ::protobuf::PbPrint::fmt(v, name, buf),
        }
    }
}
...
impl LoadParams {
    ...
    pub fn get_closed_loop(&self) -> &ClosedLoopParams {
        match self.load {
            ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(ref v)) => v,
    ...
    pub fn has_closed_loop(&self) -> bool {
        match self.load {
            ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_closed_loop(&mut self, v: ClosedLoopParams) {
        self.load = ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(v))
    }

    // Mutable pointer to the field.
    pub fn mut_closed_loop(&mut self) -> &mut ClosedLoopParams {
        if let ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(_)) = self.load {
        } else {
            self.load = ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(ClosedLoopParams::new()));
        }
        match self.load {
            ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_closed_loop(&mut self) -> ClosedLoopParams {
        if self.has_closed_loop() {
            match self.load.take() {
                ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(v)) => v,
                _ => panic!(),
            }
        } else {
            ClosedLoopParams::new()
...
impl ::protobuf::Message for LoadParams {
    fn is_initialized(&self) -> bool {
        if let Some(LoadParams_oneof_load::ClosedLoop(ref v)) = self.load {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.load = ::std::option::Option::Some(LoadParams_oneof_load::ClosedLoop(is.read_message()?));
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.load {
            match v {
                &LoadParams_oneof_load::ClosedLoop(ref v) => {
...
impl ::protobuf::PbPrint for LoadParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.load, "load", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for LoadParams {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.load, "load", &mut s);
        write!(f, "{}", s)
    }
}
...
pub struct SecurityParams {
    ...
    pub server_host_override_offset: u64,
    pub cred_type: ::std::string::String,
    pub cred_type_offset: u64,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl SecurityParams {
    ...
    pub fn get_server_host_override_offset(&self) -> &u64 {
        &self.server_host_override_offset
    }
    ...
    pub fn get_cred_type_offset(&self) -> &u64 {
        &self.cred_type_offset
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.server_host_override, &mut self.server_host_override_offset)?;
                },
                3 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cred_type, &mut self.cred_type_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl PartialEq for SecurityParams {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.use_test_ca == other.use_test_ca && self.server_host_override == other.server_host_override && self.cred_type == other.cred_type
    }
}
...
impl ::protobuf::PbPrint for SecurityParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.use_test_ca, "use_test_ca", buf);
        ::protobuf::PbPrint::fmt(&self.server_host_override, "server_host_override", buf);
        ::protobuf::PbPrint::fmt(&self.cred_type, "cred_type", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for SecurityParams {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.use_test_ca, "use_test_ca", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_host_override, "server_host_override", &mut s);
        ::protobuf::PbPrint::fmt(&self.cred_type, "cred_type", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::PbPrint for ChannelArg_oneof_value {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        match self {
            ChannelArg_oneof_value::StrValue(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            ChannelArg_oneof_value::IntValue(v) => ::protobuf::PbPrint::fmt(v, name, buf),
        }
    }
}
...
impl ChannelArg {
    ...
    pub fn get_str_value(&self) -> &str {
        match self.value {
            ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn has_str_value(&self) -> bool {
        match self.value {
            ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_str_value(&mut self, v: ::std::string::String) {
        self.value = ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(v))
    }

    // Mutable pointer to the field.
    pub fn mut_str_value(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(_)) = self.value {
        } else {
            self.value = ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(::std::string::String::new()));
        }
        match self.value {
            ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_str_value(&mut self) -> ::std::string::String {
        if self.has_str_value() {
            match self.value.take() {
                ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    pub fn get_int_value(&self) -> i32 {
        match self.value {
            ::std::option::Option::Some(ChannelArg_oneof_value::IntValue(v)) => v,
            _ => 0,
        }
    }
    ...
    pub fn has_int_value(&self) -> bool {
        match self.value {
            ::std::option::Option::Some(ChannelArg_oneof_value::IntValue(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_int_value(&mut self, v: i32) {
        self.value = ::std::option::Option::Some(ChannelArg_oneof_value::IntValue(v))
    }
...
impl ::protobuf::Message for ChannelArg {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.value = ::std::option::Option::Some(ChannelArg_oneof_value::StrValue(is.read_string()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.value = ::std::option::Option::Some(ChannelArg_oneof_value::IntValue(is.read_int32()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.value {
            match v {
                &ChannelArg_oneof_value::StrValue(ref v) => {
                    my_size += ::protobuf::rt::string_size(2, &v);
                },
                &ChannelArg_oneof_value::IntValue(v) => {
...
impl ::protobuf::PbPrint for ChannelArg {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
pub struct ClientConfig {
    ...
    pub server_targets_offset: ::std::vec::Vec<u64>,
    pub client_type: ClientType,
    pub security_params: ::protobuf::SingularPtrField<SecurityParams>,
    pub security_params_offset: u64,
...
impl ClientConfig {
    ...
    pub fn get_server_targets_offset(&self) -> &[u64] {
        &self.server_targets_offset
    }
    ...
    pub fn clear_client_type(&mut self) {
        self.client_type = ClientType::SyncClient;
    }
    ...
    pub fn get_security_params_offset(&self) -> &u64 {
        &self.security_params_offset
    }
    ...
    pub fn get_load_params_offset(&self) -> &u64 {
        &self.load_params_offset
    }
    ...
    pub fn get_payload_config_offset(&self) -> &u64 {
        &self.payload_config_offset
    }
    ...
    pub fn get_histogram_params_offset(&self) -> &u64 {
        &self.histogram_params_offset
    }
    ...
    pub fn get_other_client_api_offset(&self) -> &u64 {
        &self.other_client_api_offset
    }
    ...
    pub fn get_channel_args_offset(&self) -> &[u64] {
        &self.channel_args_offset
    }
...
impl ::protobuf::Message for ClientConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.server_targets, &mut self.server_targets_offset)?;
                },
                2 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.client_type, 2, &mut self.unknown_fields)?
                },
                3 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.security_params, &mut self.security_params_offset)?;
                },
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                10 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.load_params, &mut self.load_params_offset)?;
                },
                11 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.payload_config, &mut self.payload_config_offset)?;
                },
                12 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.histogram_params, &mut self.histogram_params_offset)?;
                },
                13 => {
                ...
                15 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.other_client_api, &mut self.other_client_api_offset)?;
                },
                16 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.channel_args, &mut self.channel_args_offset)?;
                },
                17 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.client_type != ClientType::SyncClient {
...
impl PartialEq for ClientConfig {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.server_targets == other.server_targets && self.client_type == other.client_type && self.security_params == other.security_params && self.outstanding_rpcs_per_channel == other.outstanding_rpcs_per_channel && self.client_channels == other.client_channels && self.async_client_threads == other.async_client_threads && self.rpc_type == other.rpc_type && self.load_params == other.load_params && self.payload_config == other.payload_config && self.histogram_params == other.histogram_params && self.core_list == other.core_list && self.core_limit == other.core_limit && self.other_client_api == other.other_client_api && self.channel_args == other.channel_args && self.threads_per_cq == other.threads_per_cq && self.messages_per_stream == other.messages_per_stream
    }
}
...
impl ::protobuf::PbPrint for ClientConfig {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.server_targets, "server_targets", buf);
        ::protobuf::PbPrint::fmt(&self.client_type, "client_type", buf);
        ::protobuf::PbPrint::fmt(&self.security_params, "security_params", buf);
        ::protobuf::PbPrint::fmt(&self.outstanding_rpcs_per_channel, "outstanding_rpcs_per_channel", buf);
        ::protobuf::PbPrint::fmt(&self.client_channels, "client_channels", buf);
        ::protobuf::PbPrint::fmt(&self.async_client_threads, "async_client_threads", buf);
        ::protobuf::PbPrint::fmt(&self.rpc_type, "rpc_type", buf);
        ::protobuf::PbPrint::fmt(&self.load_params, "load_params", buf);
        ::protobuf::PbPrint::fmt(&self.payload_config, "payload_config", buf);
        ::protobuf::PbPrint::fmt(&self.histogram_params, "histogram_params", buf);
        ::protobuf::PbPrint::fmt(&self.core_list, "core_list", buf);
        ::protobuf::PbPrint::fmt(&self.core_limit, "core_limit", buf);
        ::protobuf::PbPrint::fmt(&self.other_client_api, "other_client_api", buf);
        ::protobuf::PbPrint::fmt(&self.channel_args, "channel_args", buf);
        ::protobuf::PbPrint::fmt(&self.threads_per_cq, "threads_per_cq", buf);
        ::protobuf::PbPrint::fmt(&self.messages_per_stream, "messages_per_stream", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ClientConfig {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.server_targets, "server_targets", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_type, "client_type", &mut s);
        ::protobuf::PbPrint::fmt(&self.security_params, "security_params", &mut s);
        ::protobuf::PbPrint::fmt(&self.outstanding_rpcs_per_channel, "outstanding_rpcs_per_channel", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_channels, "client_channels", &mut s);
        ::protobuf::PbPrint::fmt(&self.async_client_threads, "async_client_threads", &mut s);
        ::protobuf::PbPrint::fmt(&self.rpc_type, "rpc_type", &mut s);
        ::protobuf::PbPrint::fmt(&self.load_params, "load_params", &mut s);
        ::protobuf::PbPrint::fmt(&self.payload_config, "payload_config", &mut s);
        ::protobuf::PbPrint::fmt(&self.histogram_params, "histogram_params", &mut s);
        ::protobuf::PbPrint::fmt(&self.core_list, "core_list", &mut s);
        ::protobuf::PbPrint::fmt(&self.core_limit, "core_limit", &mut s);
        ::protobuf::PbPrint::fmt(&self.other_client_api, "other_client_api", &mut s);
        ::protobuf::PbPrint::fmt(&self.channel_args, "channel_args", &mut s);
        ::protobuf::PbPrint::fmt(&self.threads_per_cq, "threads_per_cq", &mut s);
        ::protobuf::PbPrint::fmt(&self.messages_per_stream, "messages_per_stream", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ClientStatus {
    ...
    pub fn get_stats_offset(&self) -> &u64 {
        &self.stats_offset
    }
}
...
impl ::protobuf::Message for ClientStatus {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.stats, &mut self.stats_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl ::protobuf::PbPrint for ClientStatus {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::protobuf::PbPrint for Mark {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.reset, "reset", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Mark {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.reset, "reset", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::PbPrint for ClientArgs_oneof_argtype {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        match self {
            ClientArgs_oneof_argtype::Setup(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            ClientArgs_oneof_argtype::Mark(v) => ::protobuf::PbPrint::fmt(v, name, buf),
        }
    }
}
...
impl ::protobuf::PbPrint for ClientArgs {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.argtype, "argtype", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ClientArgs {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.argtype, "argtype", &mut s);
        write!(f, "{}", s)
    }
}
...
pub struct ServerConfig {
    ...
    pub other_server_api_offset: u64,
    pub threads_per_cq: i32,
...
impl ServerConfig {
    ...
    pub fn clear_server_type(&mut self) {
        self.server_type = ServerType::SyncServer;
    }
    ...
    pub fn get_other_server_api_offset(&self) -> &u64 {
        &self.other_server_api_offset
    }
...
impl ::protobuf::Message for ServerConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                11 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.other_server_api, &mut self.other_server_api_offset)?;
                },
                12 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.server_type != ServerType::SyncServer {
...
impl PartialEq for ServerConfig {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.server_type == other.server_type && self.security_params == other.security_params && self.port == other.port && self.async_server_threads == other.async_server_threads && self.core_limit == other.core_limit && self.payload_config == other.payload_config && self.core_list == other.core_list && self.other_server_api == other.other_server_api && self.threads_per_cq == other.threads_per_cq && self.resource_quota_size == other.resource_quota_size && self.channel_args == other.channel_args
    }
}
...
impl ::protobuf::PbPrint for ServerConfig {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.server_type, "server_type", buf);
        ::protobuf::PbPrint::fmt(&self.security_params, "security_params", buf);
        ::protobuf::PbPrint::fmt(&self.port, "port", buf);
        ::protobuf::PbPrint::fmt(&self.async_server_threads, "async_server_threads", buf);
        ::protobuf::PbPrint::fmt(&self.core_limit, "core_limit", buf);
        ::protobuf::PbPrint::fmt(&self.payload_config, "payload_config", buf);
        ::protobuf::PbPrint::fmt(&self.core_list, "core_list", buf);
        ::protobuf::PbPrint::fmt(&self.other_server_api, "other_server_api", buf);
        ::protobuf::PbPrint::fmt(&self.threads_per_cq, "threads_per_cq", buf);
        ::protobuf::PbPrint::fmt(&self.resource_quota_size, "resource_quota_size", buf);
        ::protobuf::PbPrint::fmt(&self.channel_args, "channel_args", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
...
impl ::std::fmt::Debug for ServerConfig {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.server_type, "server_type", &mut s);
        ::protobuf::PbPrint::fmt(&self.security_params, "security_params", &mut s);
        ::protobuf::PbPrint::fmt(&self.port, "port", &mut s);
        ::protobuf::PbPrint::fmt(&self.async_server_threads, "async_server_threads", &mut s);
        ::protobuf::PbPrint::fmt(&self.core_limit, "core_limit", &mut s);
        ::protobuf::PbPrint::fmt(&self.payload_config, "payload_config", &mut s);
        ::protobuf::PbPrint::fmt(&self.core_list, "core_list", &mut s);
        ::protobuf::PbPrint::fmt(&self.other_server_api, "other_server_api", &mut s);
        ::protobuf::PbPrint::fmt(&self.threads_per_cq, "threads_per_cq", &mut s);
        ::protobuf::PbPrint::fmt(&self.resource_quota_size, "resource_quota_size", &mut s);
        ::protobuf::PbPrint::fmt(&self.channel_args, "channel_args", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::PbPrint for ServerArgs_oneof_argtype {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        match self {
            ServerArgs_oneof_argtype::Setup(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            ServerArgs_oneof_argtype::Mark(v) => ::protobuf::PbPrint::fmt(v, name, buf),
        }
    }
}
...
impl ::protobuf::PbPrint for ServerArgs {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl PartialEq for ServerStatus {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.stats == other.stats && self.port == other.port && self.cores == other.cores
    }
}
...
impl ::protobuf::PbPrint for ServerStatus {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.stats, "stats", buf);
        ::protobuf::PbPrint::fmt(&self.port, "port", buf);
        ::protobuf::PbPrint::fmt(&self.cores, "cores", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ServerStatus {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.stats, "stats", &mut s);
        ::protobuf::PbPrint::fmt(&self.port, "port", &mut s);
        ::protobuf::PbPrint::fmt(&self.cores, "cores", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::PbPrint for CoreRequest {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
    }
}
...
impl PartialEq for CoreResponse {
...
impl ::protobuf::PbPrint for CoreResponse {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::protobuf::PbPrint for Void {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
    }
}
...
pub struct Scenario {
    ...
    pub client_config_offset: u64,
    pub num_clients: i32,
    pub server_config: ::protobuf::SingularPtrField<ServerConfig>,
    pub server_config_offset: u64,
    pub num_servers: i32,
...
impl Scenario {
    ...
    pub fn get_client_config_offset(&self) -> &u64 {
        &self.client_config_offset
    }
    ...
    pub fn get_server_config_offset(&self) -> &u64 {
        &self.server_config_offset
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.client_config, &mut self.client_config_offset)?;
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                4 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.server_config, &mut self.server_config_offset)?;
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
...
impl PartialEq for Scenario {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.name == other.name && self.client_config == other.client_config && self.num_clients == other.num_clients && self.server_config == other.server_config && self.num_servers == other.num_servers && self.warmup_seconds == other.warmup_seconds && self.benchmark_seconds == other.benchmark_seconds && self.spawn_local_worker_count == other.spawn_local_worker_count
    }
}
...
impl ::protobuf::PbPrint for Scenario {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.name, "name", buf);
        ::protobuf::PbPrint::fmt(&self.client_config, "client_config", buf);
        ::protobuf::PbPrint::fmt(&self.num_clients, "num_clients", buf);
        ::protobuf::PbPrint::fmt(&self.server_config, "server_config", buf);
        ::protobuf::PbPrint::fmt(&self.num_servers, "num_servers", buf);
        ::protobuf::PbPrint::fmt(&self.warmup_seconds, "warmup_seconds", buf);
        ::protobuf::PbPrint::fmt(&self.benchmark_seconds, "benchmark_seconds", buf);
        ::protobuf::PbPrint::fmt(&self.spawn_local_worker_count, "spawn_local_worker_count", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Scenario {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.name, "name", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_config, "client_config", &mut s);
        ::protobuf::PbPrint::fmt(&self.num_clients, "num_clients", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_config, "server_config", &mut s);
        ::protobuf::PbPrint::fmt(&self.num_servers, "num_servers", &mut s);
        ::protobuf::PbPrint::fmt(&self.warmup_seconds, "warmup_seconds", &mut s);
        ::protobuf::PbPrint::fmt(&self.benchmark_seconds, "benchmark_seconds", &mut s);
        ::protobuf::PbPrint::fmt(&self.spawn_local_worker_count, "spawn_local_worker_count", &mut s);
        write!(f, "{}", s)
    }
}
...
pub struct Scenarios {
    ...
    pub scenarios_offset: ::std::vec::Vec<u64>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Scenarios {
    ...
    pub fn get_scenarios_offset(&self) -> &[u64] {
        &self.scenarios_offset
    }
}
...
impl ::protobuf::Message for Scenarios {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.scenarios, &mut self.scenarios_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl ::protobuf::PbPrint for Scenarios {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.scenarios, "scenarios", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Scenarios {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.scenarios, "scenarios", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for ScenarioResultSummary {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.qps == other.qps && self.qps_per_server_core == other.qps_per_server_core && self.server_system_time == other.server_system_time && self.server_user_time == other.server_user_time && self.client_system_time == other.client_system_time && self.client_user_time == other.client_user_time && self.latency_50 == other.latency_50 && self.latency_90 == other.latency_90 && self.latency_95 == other.latency_95 && self.latency_99 == other.latency_99 && self.latency_999 == other.latency_999 && self.server_cpu_usage == other.server_cpu_usage && self.successful_requests_per_second == other.successful_requests_per_second && self.failed_requests_per_second == other.failed_requests_per_second && self.client_polls_per_request == other.client_polls_per_request && self.server_polls_per_request == other.server_polls_per_request && self.server_queries_per_cpu_sec == other.server_queries_per_cpu_sec && self.client_queries_per_cpu_sec == other.client_queries_per_cpu_sec
    }
}
...
impl ::protobuf::PbPrint for ScenarioResultSummary {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.qps, "qps", buf);
        ::protobuf::PbPrint::fmt(&self.qps_per_server_core, "qps_per_server_core", buf);
        ::protobuf::PbPrint::fmt(&self.server_system_time, "server_system_time", buf);
        ::protobuf::PbPrint::fmt(&self.server_user_time, "server_user_time", buf);
        ::protobuf::PbPrint::fmt(&self.client_system_time, "client_system_time", buf);
        ::protobuf::PbPrint::fmt(&self.client_user_time, "client_user_time", buf);
        ::protobuf::PbPrint::fmt(&self.latency_50, "latency_50", buf);
        ::protobuf::PbPrint::fmt(&self.latency_90, "latency_90", buf);
        ::protobuf::PbPrint::fmt(&self.latency_95, "latency_95", buf);
        ::protobuf::PbPrint::fmt(&self.latency_99, "latency_99", buf);
        ::protobuf::PbPrint::fmt(&self.latency_999, "latency_999", buf);
        ::protobuf::PbPrint::fmt(&self.server_cpu_usage, "server_cpu_usage", buf);
        ::protobuf::PbPrint::fmt(&self.successful_requests_per_second, "successful_requests_per_second", buf);
        ::protobuf::PbPrint::fmt(&self.failed_requests_per_second, "failed_requests_per_second", buf);
        ::protobuf::PbPrint::fmt(&self.client_polls_per_request, "client_polls_per_request", buf);
        ::protobuf::PbPrint::fmt(&self.server_polls_per_request, "server_polls_per_request", buf);
        ::protobuf::PbPrint::fmt(&self.server_queries_per_cpu_sec, "server_queries_per_cpu_sec", buf);
        ::protobuf::PbPrint::fmt(&self.client_queries_per_cpu_sec, "client_queries_per_cpu_sec", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ScenarioResultSummary {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.qps, "qps", &mut s);
        ::protobuf::PbPrint::fmt(&self.qps_per_server_core, "qps_per_server_core", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_system_time, "server_system_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_user_time, "server_user_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_system_time, "client_system_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_user_time, "client_user_time", &mut s);
        ::protobuf::PbPrint::fmt(&self.latency_50, "latency_50", &mut s);
        ::protobuf::PbPrint::fmt(&self.latency_90, "latency_90", &mut s);
        ::protobuf::PbPrint::fmt(&self.latency_95, "latency_95", &mut s);
        ::protobuf::PbPrint::fmt(&self.latency_99, "latency_99", &mut s);
        ::protobuf::PbPrint::fmt(&self.latency_999, "latency_999", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_cpu_usage, "server_cpu_usage", &mut s);
        ::protobuf::PbPrint::fmt(&self.successful_requests_per_second, "successful_requests_per_second", &mut s);
        ::protobuf::PbPrint::fmt(&self.failed_requests_per_second, "failed_requests_per_second", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_polls_per_request, "client_polls_per_request", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_polls_per_request, "server_polls_per_request", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_queries_per_cpu_sec, "server_queries_per_cpu_sec", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_queries_per_cpu_sec, "client_queries_per_cpu_sec", &mut s);
        write!(f, "{}", s)
    }
}
...
pub struct ScenarioResult {
    ...
    pub request_results_offset: ::std::vec::Vec<u64>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ScenarioResult {
    ...
    pub fn get_scenario_offset(&self) -> &u64 {
    ...
    pub fn get_latencies_offset(&self) -> &u64 {
        &self.latencies_offset
    }
    ...
    pub fn get_client_stats_offset(&self) -> &[u64] {
        &self.client_stats_offset
    }
    ...
    pub fn get_server_stats_offset(&self) -> &[u64] {
        &self.server_stats_offset
    }
    ...
    pub fn get_request_results_offset(&self) -> &[u64] {
        &self.request_results_offset
    }
}
...
impl ::protobuf::Message for ScenarioResult {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.scenario, &mut self.scenario_offset)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.latencies, &mut self.latencies_offset)?;
                },
                3 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.client_stats, &mut self.client_stats_offset)?;
                },
                4 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.server_stats, &mut self.server_stats_offset)?;
                },
                5 => {
                ...
                9 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.request_results, &mut self.request_results_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl PartialEq for ScenarioResult {
    ...
    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.scenario == other.scenario && self.latencies == other.latencies && self.client_stats == other.client_stats && self.server_stats == other.server_stats && self.server_cores == other.server_cores && self.summary == other.summary && self.client_success == other.client_success && self.server_success == other.server_success && self.request_results == other.request_results
    }
}
...
impl ::protobuf::PbPrint for ScenarioResult {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.scenario, "scenario", buf);
        ::protobuf::PbPrint::fmt(&self.latencies, "latencies", buf);
        ::protobuf::PbPrint::fmt(&self.client_stats, "client_stats", buf);
        ::protobuf::PbPrint::fmt(&self.server_stats, "server_stats", buf);
        ::protobuf::PbPrint::fmt(&self.server_cores, "server_cores", buf);
        ::protobuf::PbPrint::fmt(&self.summary, "summary", buf);
        ::protobuf::PbPrint::fmt(&self.client_success, "client_success", buf);
        ::protobuf::PbPrint::fmt(&self.server_success, "server_success", buf);
        ::protobuf::PbPrint::fmt(&self.request_results, "request_results", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ScenarioResult {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = ::std::string::String::new();
        ::protobuf::PbPrint::fmt(&self.scenario, "scenario", &mut s);
        ::protobuf::PbPrint::fmt(&self.latencies, "latencies", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_stats, "client_stats", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_stats, "server_stats", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_cores, "server_cores", &mut s);
        ::protobuf::PbPrint::fmt(&self.summary, "summary", &mut s);
        ::protobuf::PbPrint::fmt(&self.client_success, "client_success", &mut s);
        ::protobuf::PbPrint::fmt(&self.server_success, "server_success", &mut s);
        ::protobuf::PbPrint::fmt(&self.request_results, "request_results", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::ProtobufEnum for ClientType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ClientType> {
        match value {
            0 => ::std::option::Option::Some(ClientType::SyncClient),
            1 => ::std::option::Option::Some(ClientType::AsyncClient),
            2 => ::std::option::Option::Some(ClientType::OtherClient),
...
impl ::protobuf::PbPrint for ClientType {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        use std::fmt::Write;
        if *self == ClientType::default() {
            return;
        }
...
impl ::protobuf::ProtobufEnum for ServerType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ServerType> {
        match value {
            0 => ::std::option::Option::Some(ServerType::SyncServer),
            1 => ::std::option::Option::Some(ServerType::AsyncServer),
            2 => ::std::option::Option::Some(ServerType::AsyncGenericServer),
            3 => ::std::option::Option::Some(ServerType::OtherServer),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::PbPrint for ServerType {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        use std::fmt::Write;
        if *self == ServerType::default() {
            return;
        }
        ::protobuf::push_field_start(name, buf);
        write!(buf, "{:?}", self).unwrap();
...
impl ::protobuf::ProtobufEnum for RpcType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<RpcType> {
        match value {
            ...
            2 => ::std::option::Option::Some(RpcType::StreamingFromClient),
            3 => ::std::option::Option::Some(RpcType::StreamingFromServer),
            4 => ::std::option::Option::Some(RpcType::StreamingBothWays),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::PbPrint for RpcType {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        use std::fmt::Write;
        if *self == RpcType::default() {
            return;
        }
        ::protobuf::push_field_start(name, buf);
        write!(buf, "{:?}", self).unwrap();
