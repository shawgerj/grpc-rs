...
impl PartialEq for ByteBufferParams {

    #[allow(unused_variables)]
    fn eq(&self, other: &Self) -> bool {
        self.req_size == other.req_size && self.resp_size == other.resp_size
    }
}
...
impl ::protobuf::PbPrint for ByteBufferParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.req_size, "req_size", buf);
        ::protobuf::PbPrint::fmt(&self.resp_size, "resp_size", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for ByteBufferParams {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.req_size, "req_size", &mut s);
        ::protobuf::PbPrint::fmt(&self.resp_size, "resp_size", &mut s);
        write!(f, "{}", s)
    }
}
...
impl PartialEq for SimpleProtoParams {
...
impl ::protobuf::PbPrint for SimpleProtoParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl PartialEq for ComplexProtoParams {
...
impl ::protobuf::PbPrint for ComplexProtoParams {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
    }
}
...
impl ::protobuf::PbPrint for PayloadConfig_oneof_payload {
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        match self {
            PayloadConfig_oneof_payload::BytebufParams(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            PayloadConfig_oneof_payload::SimpleParams(v) => ::protobuf::PbPrint::fmt(v, name, buf),
            PayloadConfig_oneof_payload::ComplexParams(v) => ::protobuf::PbPrint::fmt(v, name, buf),
        }
    }
}
...
impl PayloadConfig {
    ...
    pub fn get_bytebuf_params(&self) -> &ByteBufferParams {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(ref v)) => v,
    ...
    pub fn has_bytebuf_params(&self) -> bool {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_bytebuf_params(&mut self, v: ByteBufferParams) {
        self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(v))
    }

    // Mutable pointer to the field.
    pub fn mut_bytebuf_params(&mut self) -> &mut ByteBufferParams {
        if let ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(_)) = self.payload {
        } else {
            self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(ByteBufferParams::new()));
        }
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_bytebuf_params(&mut self) -> ByteBufferParams {
        if self.has_bytebuf_params() {
            match self.payload.take() {
                ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(v)) => v,
                _ => panic!(),
            }
        } else {
            ByteBufferParams::new()
    ...
    pub fn get_simple_params(&self) -> &SimpleProtoParams {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(ref v)) => v,
    ...
    pub fn has_simple_params(&self) -> bool {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_simple_params(&mut self, v: SimpleProtoParams) {
        self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(v))
    }

    // Mutable pointer to the field.
    pub fn mut_simple_params(&mut self) -> &mut SimpleProtoParams {
        if let ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(_)) = self.payload {
        } else {
            self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(SimpleProtoParams::new()));
        }
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_simple_params(&mut self) -> SimpleProtoParams {
        if self.has_simple_params() {
            match self.payload.take() {
                ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(v)) => v,
                _ => panic!(),
            }
        } else {
            SimpleProtoParams::new()
    ...
    pub fn get_complex_params(&self) -> &ComplexProtoParams {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(ref v)) => v,
    ...
    pub fn has_complex_params(&self) -> bool {
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_complex_params(&mut self, v: ComplexProtoParams) {
        self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(v))
    }

    // Mutable pointer to the field.
    pub fn mut_complex_params(&mut self) -> &mut ComplexProtoParams {
        if let ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(_)) = self.payload {
        } else {
            self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(ComplexProtoParams::new()));
        }
        match self.payload {
            ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_complex_params(&mut self) -> ComplexProtoParams {
        if self.has_complex_params() {
            match self.payload.take() {
                ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(v)) => v,
                _ => panic!(),
            }
        } else {
            ComplexProtoParams::new()
...
impl ::protobuf::Message for PayloadConfig {
    fn is_initialized(&self) -> bool {
        if let Some(PayloadConfig_oneof_payload::BytebufParams(ref v)) = self.payload {
            if !v.is_initialized() {
                return false;
            }
        }
        if let Some(PayloadConfig_oneof_payload::SimpleParams(ref v)) = self.payload {
            if !v.is_initialized() {
                return false;
            }
        }
        if let Some(PayloadConfig_oneof_payload::ComplexParams(ref v)) = self.payload {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::BytebufParams(is.read_message()?));
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::SimpleParams(is.read_message()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.payload = ::std::option::Option::Some(PayloadConfig_oneof_payload::ComplexParams(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.payload {
            match v {
                &PayloadConfig_oneof_payload::BytebufParams(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &PayloadConfig_oneof_payload::SimpleParams(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &PayloadConfig_oneof_payload::ComplexParams(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
...
impl ::protobuf::PbPrint for PayloadConfig {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
