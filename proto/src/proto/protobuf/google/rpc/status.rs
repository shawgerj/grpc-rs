...
pub struct Status {
    ...
    pub details_offset: ::std::vec::Vec<u64>,
    // special fields
...
impl Status {
    ...
    pub fn get_details_offset(&self) -> &[u64] {
        &self.details_offset
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.details, &mut self.details_offset)?;
                },
                _ => {
...
impl ::protobuf::PbPrint for Status {
    ...
    fn fmt(&self, name: &str, buf: &mut ::std::string::String) {
        ...
        ::protobuf::PbPrint::fmt(&self.details, "details", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Status {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.details, "details", &mut s);
        write!(f, "{}", s)
    }
}
